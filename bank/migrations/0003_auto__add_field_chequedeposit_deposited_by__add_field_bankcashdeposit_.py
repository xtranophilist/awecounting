...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ChequeDeposit.deposited_by'
        db.add_column(u'bank_chequedeposit', 'deposited_by',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'BankCashDeposit.deposited_by'
        db.add_column(u'bank_bankcashdeposit', 'deposited_by',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ChequeDeposit.deposited_by'
        db.delete_column(u'bank_chequedeposit', 'deposited_by')

        # Deleting field 'BankCashDeposit.deposited_by'
        db.delete_column(u'bank_bankcashdeposit', 'deposited_by')
    ...
    models = {
        ...
        u'bank.bankcashdeposit': {
            ...
            'deposited_by': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
