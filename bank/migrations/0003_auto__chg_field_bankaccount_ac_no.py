...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'BankAccount.ac_no'
        db.alter_column(u'bank_bankaccount', 'ac_no', self.gf('django.db.models.fields.CharField')(max_length=50))

    def backwards(self, orm):

        # Changing field 'BankAccount.ac_no'
        db.alter_column(u'bank_bankaccount', 'ac_no', self.gf('django.db.models.fields.IntegerField')())
