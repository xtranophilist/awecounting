...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ElectronicFundTransferOut.status'
        db.add_column(u'bank_electronicfundtransferout', 'status',
                      self.gf('django.db.models.fields.CharField')(default='Unapproved', max_length=10),
                      keep_default=False)

        # Adding field 'ElectronicFundTransferIn.status'
        db.add_column(u'bank_electronicfundtransferin', 'status',
                      self.gf('django.db.models.fields.CharField')(default='Unapproved', max_length=10),
                      keep_default=False)

        # Adding field 'ChequePayment.status'
        db.add_column(u'bank_chequepayment', 'status',
                      self.gf('django.db.models.fields.CharField')(default='Unapproved', max_length=10),
                      keep_default=False)

        # Adding field 'BankCashDeposit.status'
        db.add_column(u'bank_bankcashdeposit', 'status',
                      self.gf('django.db.models.fields.CharField')(default='Unapproved', max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ElectronicFundTransferOut.status'
        db.delete_column(u'bank_electronicfundtransferout', 'status')

        # Deleting field 'ElectronicFundTransferIn.status'
        db.delete_column(u'bank_electronicfundtransferin', 'status')

        # Deleting field 'ChequePayment.status'
        db.delete_column(u'bank_chequepayment', 'status')

        # Deleting field 'BankCashDeposit.status'
        db.delete_column(u'bank_bankcashdeposit', 'status')
