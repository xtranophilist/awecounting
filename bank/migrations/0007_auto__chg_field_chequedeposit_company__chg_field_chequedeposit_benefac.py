...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'bank_chequedeposit', 'company_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['users.Company']))

        # Changing field 'ChequeDeposit.benefactor'
        db.alter_column(u'bank_chequedeposit', 'benefactor_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['ledger.Account']))

        # Changing field 'ChequeDeposit.date'
        db.alter_column(u'bank_chequedeposit', 'date', self.gf('django.db.models.fields.DateField')(default=None))

        # Changing field 'ChequeDeposit.bank_account'
        db.alter_column(u'bank_chequedeposit', 'bank_account_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['ledger.Account']))
