...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ChequePayment.attachment'
        db.add_column(u'bank_chequepayment', 'attachment',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ChequePayment.attachment'
        db.delete_column(u'bank_chequepayment', 'attachment')
