...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Currency.latest_usd_rate'
        db.alter_column('currency', 'latest_usd_rate', self.gf('django.db.models.fields.FloatField')(null=True))

    def backwards(self, orm):

        # Changing field 'Currency.latest_usd_rate'
        db.alter_column('currency', 'latest_usd_rate', self.gf('django.db.models.fields.FloatField')(default=None))
