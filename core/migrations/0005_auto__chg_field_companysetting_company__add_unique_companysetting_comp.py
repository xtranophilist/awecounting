...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CompanySetting.company'
        db.alter_column(u'core_companysetting', 'company_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['users.Company']))
        # Adding unique constraint on 'CompanySetting', fields ['company']
        db.create_unique(u'core_companysetting', ['company_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'CompanySetting', fields ['company']
        db.delete_unique(u'core_companysetting', ['company_id'])


        # Changing field 'CompanySetting.company'
        db.alter_column(u'core_companysetting', 'company_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.Company']))
    ...
    models = {
        ...
        u'core.vouchersetting': {
            ...
            'voucher_number_start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 11, 18, 0, 0)'})
        },
        u'users.company': {
