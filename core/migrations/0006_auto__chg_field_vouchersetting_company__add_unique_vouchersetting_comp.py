...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'VoucherSetting.company'
        db.alter_column(u'core_vouchersetting', 'company_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['users.Company']))
        # Adding unique constraint on 'VoucherSetting', fields ['company']
        db.create_unique(u'core_vouchersetting', ['company_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'VoucherSetting', fields ['company']
        db.delete_unique(u'core_vouchersetting', ['company_id'])


        # Changing field 'VoucherSetting.company'
        db.alter_column(u'core_vouchersetting', 'company_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.Company']))
