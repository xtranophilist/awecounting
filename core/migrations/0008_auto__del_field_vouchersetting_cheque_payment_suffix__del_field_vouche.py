...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'VoucherSetting.cheque_payment_suffix'
        db.delete_column(u'core_vouchersetting', 'cheque_payment_suffix')

        # Deleting field 'VoucherSetting.cheque_payment_prefix'
        db.delete_column(u'core_vouchersetting', 'cheque_payment_prefix')

        # Deleting field 'VoucherSetting.fixed_assets_purchase_voucher_suffix'
        db.delete_column(u'core_vouchersetting', 'fixed_assets_purchase_voucher_suffix')

        # Deleting field 'VoucherSetting.fixed_assets_purchase_voucher_prefix'
        db.delete_column(u'core_vouchersetting', 'fixed_assets_purchase_voucher_prefix')

        # Deleting field 'VoucherSetting.eft_out_prefix'
        db.delete_column(u'core_vouchersetting', 'eft_out_prefix')

        # Deleting field 'VoucherSetting.fixed_assets_purchase_voucher_heading'
        db.delete_column(u'core_vouchersetting', 'fixed_assets_purchase_voucher_heading')

        # Deleting field 'VoucherSetting.eft_out_suffix'
        db.delete_column(u'core_vouchersetting', 'eft_out_suffix')
        ...
        # Adding field 'VoucherSetting.fixed_assets_prefix'
        db.add_column(u'core_vouchersetting', 'fixed_assets_prefix',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=5, null=True, blank=True),
                      keep_default=False)

        # Adding field 'VoucherSetting.fixed_assets_suffix'
        db.add_column(u'core_vouchersetting', 'fixed_assets_suffix',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=5, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'VoucherSetting.cheque_payment_suffix'
        db.add_column(u'core_vouchersetting', 'cheque_payment_suffix',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=5, null=True, blank=True),
                      keep_default=False)

        # Adding field 'VoucherSetting.cheque_payment_prefix'
        db.add_column(u'core_vouchersetting', 'cheque_payment_prefix',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=5, null=True, blank=True),
                      keep_default=False)

        # Adding field 'VoucherSetting.fixed_assets_purchase_voucher_suffix'
        db.add_column(u'core_vouchersetting', 'fixed_assets_purchase_voucher_suffix',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=5, null=True, blank=True),
                      keep_default=False)

        # Adding field 'VoucherSetting.fixed_assets_purchase_voucher_prefix'
        db.add_column(u'core_vouchersetting', 'fixed_assets_purchase_voucher_prefix',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=5, null=True, blank=True),
                      keep_default=False)

        # Adding field 'VoucherSetting.eft_out_prefix'
        db.add_column(u'core_vouchersetting', 'eft_out_prefix',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=5, null=True, blank=True),
                      keep_default=False)

        # Adding field 'VoucherSetting.fixed_assets_purchase_voucher_heading'
        db.add_column(u'core_vouchersetting', 'fixed_assets_purchase_voucher_heading',
                      self.gf('django.db.models.fields.CharField')(default='Fixed Assets Purchase Voucher', max_length=100),
                      keep_default=False)

        # Adding field 'VoucherSetting.eft_out_suffix'
        db.add_column(u'core_vouchersetting', 'eft_out_suffix',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=5, null=True, blank=True),
                      keep_default=False)
        ...
        # Deleting field 'VoucherSetting.fixed_assets_prefix'
        db.delete_column(u'core_vouchersetting', 'fixed_assets_prefix')

        # Deleting field 'VoucherSetting.fixed_assets_suffix'
        db.delete_column(u'core_vouchersetting', 'fixed_assets_suffix')
