...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'daybook_cashsales', (
            ...
            ('day_book', self.gf('django.db.models.fields.related.ForeignKey')(related_name='cash_sales', to=orm['daybook.DayBook'])),
        ))
        db.send_create_signal(u'daybook', ['CashSales'])

        # Adding model 'CashPurchase'
        db.create_table(u'daybook_cashpurchase', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sn', self.gf('django.db.models.fields.IntegerField')()),
            ('purchase_ledger', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ledger.Account'])),
            ('amount', self.gf('django.db.models.fields.FloatField')()),
            ('day_book', self.gf('django.db.models.fields.related.ForeignKey')(related_name='cash_purchase', to=orm['daybook.DayBook'])),
        ))
        db.send_create_signal(u'daybook', ['CashPurchase'])

        # Adding model 'CashReceipt'
        db.create_table(u'daybook_cashreceipt', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sn', self.gf('django.db.models.fields.IntegerField')()),
            ('received_from', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ledger.Account'])),
            ('amount', self.gf('django.db.models.fields.FloatField')()),
            ('day_book', self.gf('django.db.models.fields.related.ForeignKey')(related_name='cash_receipt', to=orm['daybook.DayBook'])),
        ))
        db.send_create_signal(u'daybook', ['CashReceipt'])

        # Adding model 'CashPayment'
        db.create_table(u'daybook_cashpayment', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sn', self.gf('django.db.models.fields.IntegerField')()),
            ('payment_to', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ledger.Account'])),
            ('amount', self.gf('django.db.models.fields.FloatField')()),
            ('day_book', self.gf('django.db.models.fields.related.ForeignKey')(related_name='cash_payment', to=orm['daybook.DayBook'])),
        ))
        db.send_create_signal(u'daybook', ['CashPayment'])

        # Adding model 'CreditSales'
        db.create_table(u'daybook_creditsales', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sn', self.gf('django.db.models.fields.IntegerField')()),
            ...
            ('amount', self.gf('django.db.models.fields.FloatField')()),
            ('day_book', self.gf('django.db.models.fields.related.ForeignKey')(related_name='credit_sales', to=orm['daybook.DayBook'])),
        ))
        db.send_create_signal(u'daybook', ['CreditSales'])

        # Adding model 'CreditPurchase'
        db.create_table(u'daybook_creditpurchase', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sn', self.gf('django.db.models.fields.IntegerField')()),
            ...
            ('amount', self.gf('django.db.models.fields.FloatField')()),
            ('day_book', self.gf('django.db.models.fields.related.ForeignKey')(related_name='credit_purchase', to=orm['daybook.DayBook'])),
        ))
        db.send_create_signal(u'daybook', ['CreditPurchase'])

        # Adding model 'CreditExpense'
        db.create_table(u'daybook_creditexpense', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sn', self.gf('django.db.models.fields.IntegerField')()),
            ...
            ('amount', self.gf('django.db.models.fields.FloatField')()),
            ('day_book', self.gf('django.db.models.fields.related.ForeignKey')(related_name='credit_expense', to=orm['daybook.DayBook'])),
        ))
        db.send_create_signal(u'daybook', ['CreditExpense'])

        # Adding model 'CreditIncome'
        db.create_table(u'daybook_creditincome', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sn', self.gf('django.db.models.fields.IntegerField')()),
            ...
            ('amount', self.gf('django.db.models.fields.FloatField')()),
            ('day_book', self.gf('django.db.models.fields.related.ForeignKey')(related_name='credit_income', to=orm['daybook.DayBook'])),
        ))
        db.send_create_signal(u'daybook', ['CreditIncome'])

        # Adding model 'SummaryCash'
        db.create_table(u'daybook_summarycash', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('closing', self.gf('django.db.models.fields.FloatField')()),
            ('day_book', self.gf('django.db.models.fields.related.ForeignKey')(related_name='summary_cash', to=orm['daybook.DayBook'])),
        ))
        db.send_create_signal(u'daybook', ['SummaryCash'])

        # Adding model 'SummaryEquivalent'
        db.create_table(u'daybook_summaryequivalent', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sn', self.gf('django.db.models.fields.IntegerField')()),
            ...
            ('closing', self.gf('django.db.models.fields.FloatField')()),
            ('day_book', self.gf('django.db.models.fields.related.ForeignKey')(related_name='summary_equivalent', to=orm['daybook.DayBook'])),
        ))
        db.send_create_signal(u'daybook', ['SummaryEquivalent'])

        # Adding model 'SummaryTransfer'
        db.create_table(u'daybook_summarytransfer', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sn', self.gf('django.db.models.fields.IntegerField')()),
            ('transfer_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ledger.Account'])),
            ('inward', self.gf('django.db.models.fields.FloatField')()),
            ('outward', self.gf('django.db.models.fields.FloatField')()),
            ('day_book', self.gf('django.db.models.fields.related.ForeignKey')(related_name='summary_transfer', to=orm['daybook.DayBook'])),
        ))
        db.send_create_signal(u'daybook', ['SummaryTransfer'])

        # Adding model 'SummaryBank'
        db.create_table(u'daybook_summarybank', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sn', self.gf('django.db.models.fields.IntegerField')()),
            ...
            ('day_book', self.gf('django.db.models.fields.related.ForeignKey')(related_name='summary_bank', to=orm['daybook.DayBook'])),
        ))
        db.send_create_signal(u'daybook', ['SummaryBank'])

        # Adding model 'SummarySalesTax'
        db.create_table(u'daybook_summarysalestax', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sn', self.gf('django.db.models.fields.IntegerField')()),
            ('tax_scheme', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ledger.Account'])),
            ('amount', self.gf('django.db.models.fields.FloatField')()),
            ('day_book', self.gf('django.db.models.fields.related.ForeignKey')(related_name='summary_sales_tax', to=orm['daybook.DayBook'])),
        ))
        db.send_create_signal(u'daybook', ['SummarySalesTax'])

        # Adding model 'SummaryInventory'
        db.create_table(u'daybook_summaryinventory', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sn', self.gf('django.db.models.fields.IntegerField')()),
            ('particular', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ledger.Account'])),
            ...
            ('day_book', self.gf('django.db.models.fields.related.ForeignKey')(related_name='summary_inventory', to=orm['daybook.DayBook'])),
        ))
        db.send_create_signal(u'daybook', ['SummaryInventory'])


    def backwards(self, orm):
        # Deleting model 'DayBook'
        db.delete_table('daybook')

        # Deleting model 'CashSales'
        db.delete_table(u'daybook_cashsales')

        # Deleting model 'CashPurchase'
        db.delete_table(u'daybook_cashpurchase')

        # Deleting model 'CashReceipt'
        db.delete_table(u'daybook_cashreceipt')

        # Deleting model 'CashPayment'
        db.delete_table(u'daybook_cashpayment')

        # Deleting model 'CreditSales'
        db.delete_table(u'daybook_creditsales')

        # Deleting model 'CreditPurchase'
        db.delete_table(u'daybook_creditpurchase')

        # Deleting model 'CreditExpense'
        db.delete_table(u'daybook_creditexpense')

        # Deleting model 'CreditIncome'
        db.delete_table(u'daybook_creditincome')

        # Deleting model 'SummaryCash'
        db.delete_table(u'daybook_summarycash')

        # Deleting model 'SummaryEquivalent'
        db.delete_table(u'daybook_summaryequivalent')

        # Deleting model 'SummaryTransfer'
        db.delete_table(u'daybook_summarytransfer')

        # Deleting model 'SummaryBank'
        db.delete_table(u'daybook_summarybank')

        # Deleting model 'SummarySalesTax'
        db.delete_table(u'daybook_summarysalestax')

        # Deleting model 'SummaryInventory'
        db.delete_table(u'daybook_summaryinventory')


    models = {
        u'daybook.cashpayment': {
            'Meta': {'object_name': 'CashPayment'},
            'amount': ('django.db.models.fields.FloatField', [], {}),
            'day_book': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'cash_payment'", 'to': u"orm['daybook.DayBook']"}),
        ...
        u'daybook.cashpurchase': {
            'Meta': {'object_name': 'CashPurchase'},
            'amount': ('django.db.models.fields.FloatField', [], {}),
            'day_book': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'cash_purchase'", 'to': u"orm['daybook.DayBook']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'purchase_ledger': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['ledger.Account']"}),
            'sn': ('django.db.models.fields.IntegerField', [], {})
        },
        u'daybook.cashreceipt': {
            'Meta': {'object_name': 'CashReceipt'},
            'amount': ('django.db.models.fields.FloatField', [], {}),
            'day_book': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'cash_receipt'", 'to': u"orm['daybook.DayBook']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'daybook.cashsales': {
            ...
            'amount': ('django.db.models.fields.FloatField', [], {}),
            'day_book': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'cash_sales'", 'to': u"orm['daybook.DayBook']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'sales_ledger': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['ledger.Account']"}),
            'sn': ('django.db.models.fields.IntegerField', [], {})
        },
        u'daybook.creditexpense': {
            'Meta': {'object_name': 'CreditExpense'},
            'amount': ('django.db.models.fields.FloatField', [], {}),
            'day_book': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'credit_expense'", 'to': u"orm['daybook.DayBook']"}),
        ...
        u'daybook.creditincome': {
            'Meta': {'object_name': 'CreditIncome'},
            'amount': ('django.db.models.fields.FloatField', [], {}),
            'day_book': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'credit_income'", 'to': u"orm['daybook.DayBook']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'daybook.creditpurchase': {
            'Meta': {'object_name': 'CreditPurchase'},
            'amount': ('django.db.models.fields.FloatField', [], {}),
            'day_book': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'credit_purchase'", 'to': u"orm['daybook.DayBook']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'daybook.creditsales': {
            ...
            'day_book': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'credit_sales'", 'to': u"orm['daybook.DayBook']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'sales_ledger': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'sales_ledger'", 'to': u"orm['ledger.Account']"}),
            'sn': ('django.db.models.fields.IntegerField', [], {})
        },
        u'daybook.daybook': {
            'Meta': {'object_name': 'DayBook', 'db_table': "'daybook'"},
            'company': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['users.Company']"}),
            'date': ('django.db.models.fields.DateField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        u'daybook.summarybank': {
            ...
            'day_book': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'summary_bank'", 'to': u"orm['daybook.DayBook']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'sn': ('django.db.models.fields.IntegerField', [], {})
        },
        u'daybook.summarycash': {
            'Meta': {'object_name': 'SummaryCash'},
            'closing': ('django.db.models.fields.FloatField', [], {}),
            'day_book': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'summary_cash'", 'to': u"orm['daybook.DayBook']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        u'daybook.summaryequivalent': {
            'Meta': {'object_name': 'SummaryEquivalent'},
            'closing': ('django.db.models.fields.FloatField', [], {}),
            'day_book': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'summary_equivalent'", 'to': u"orm['daybook.DayBook']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'daybook.summaryinventory': {
            'Meta': {'object_name': 'SummaryInventory'},
            'actual': ('django.db.models.fields.FloatField', [], {}),
            'day_book': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'summary_inventory'", 'to': u"orm['daybook.DayBook']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'particular': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['ledger.Account']"}),
        ...
        u'daybook.summarysalestax': {
            'Meta': {'object_name': 'SummarySalesTax'},
            'amount': ('django.db.models.fields.FloatField', [], {}),
            'day_book': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'summary_sales_tax'", 'to': u"orm['daybook.DayBook']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'sn': ('django.db.models.fields.IntegerField', [], {}),
            'tax_scheme': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['ledger.Account']"})
        },
        u'daybook.summarytransfer': {
            'Meta': {'object_name': 'SummaryTransfer'},
            'day_book': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'summary_transfer'", 'to': u"orm['daybook.DayBook']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inward': ('django.db.models.fields.FloatField', [], {}),
            'outward': ('django.db.models.fields.FloatField', [], {}),
            'sn': ('django.db.models.fields.IntegerField', [], {}),
