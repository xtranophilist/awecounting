...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Deleting field 'SummaryCash.closing'
        db.delete_column(u'dayjournal_summarycash', 'closing')

        # Adding field 'SummaryCash.actual'
        db.add_column(u'dayjournal_summarycash', 'actual',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'SummaryCash.closing'
        db.add_column(u'dayjournal_summarycash', 'closing',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Deleting field 'SummaryCash.actual'
        db.delete_column(u'dayjournal_summarycash', 'actual')
