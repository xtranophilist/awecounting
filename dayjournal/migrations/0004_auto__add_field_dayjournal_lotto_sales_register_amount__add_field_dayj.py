...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DayJournal.lotto_sales_register_amount'
        db.add_column('day_journal', 'lotto_sales_register_amount',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'DayJournal.scratch_off_sales_register_amount'
        db.add_column('day_journal', 'scratch_off_sales_register_amount',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DayJournal.lotto_sales_register_amount'
        db.delete_column('day_journal', 'lotto_sales_register_amount')

        # Deleting field 'DayJournal.scratch_off_sales_register_amount'
        db.delete_column('day_journal', 'scratch_off_sales_register_amount')
