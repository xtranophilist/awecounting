...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Deleting field 'SummaryBank.card_deposit'
        db.delete_column(u'dayjournal_summarybank', 'card_deposit')

        # Deleting field 'SummaryBank.account_transfer_minus'
        db.delete_column(u'dayjournal_summarybank', 'account_transfer_minus')

        # Deleting field 'SummaryBank.account_transfer_plus'
        db.delete_column(u'dayjournal_summarybank', 'account_transfer_plus')

        # Adding field 'SummaryBank.cheque_deposit'
        db.add_column(u'dayjournal_summarybank', 'cheque_deposit',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'SummaryBank.card_deposit'
        db.add_column(u'dayjournal_summarybank', 'card_deposit',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'SummaryBank.account_transfer_minus'
        db.add_column(u'dayjournal_summarybank', 'account_transfer_minus',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'SummaryBank.account_transfer_plus'
        db.add_column(u'dayjournal_summarybank', 'account_transfer_plus',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Deleting field 'SummaryBank.cheque_deposit'
        db.delete_column(u'dayjournal_summarybank', 'cheque_deposit')
