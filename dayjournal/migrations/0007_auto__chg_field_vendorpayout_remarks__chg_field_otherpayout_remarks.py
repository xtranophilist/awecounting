...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'VendorPayout.remarks'
        db.alter_column(u'dayjournal_vendorpayout', 'remarks', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'OtherPayout.remarks'
        db.alter_column(u'dayjournal_otherpayout', 'remarks', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'VendorPayout.remarks'
        db.alter_column(u'dayjournal_vendorpayout', 'remarks', self.gf('django.db.models.fields.TextField')(default=None))

        # Changing field 'OtherPayout.remarks'
        db.alter_column(u'dayjournal_otherpayout', 'remarks', self.gf('django.db.models.fields.TextField')(default=None))
