...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'SummaryUtility.sn'
        db.delete_column(u'dayjournal_summaryutility', 'sn')


    def backwards(self, orm):
        # Adding field 'SummaryUtility.sn'
        db.add_column(u'dayjournal_summaryutility', 'sn',
