...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SummaryInventory.opening'
        db.add_column(u'dayjournal_summaryinventory', 'opening',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


        # Changing field 'SummaryInventory.purchase'
        db.alter_column(u'dayjournal_summaryinventory', 'purchase', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'SummaryInventory.actual'
        db.alter_column(u'dayjournal_summaryinventory', 'actual', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'SummaryInventory.sales'
        db.alter_column(u'dayjournal_summaryinventory', 'sales', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'SummaryInventory.particular'
        db.alter_column(u'dayjournal_summaryinventory', 'particular_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['inventory.InventoryAccount']))

    def backwards(self, orm):
        # Deleting field 'SummaryInventory.opening'
        db.delete_column(u'dayjournal_summaryinventory', 'opening')


        # Changing field 'SummaryInventory.purchase'
        db.alter_column(u'dayjournal_summaryinventory', 'purchase', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'SummaryInventory.actual'
        db.alter_column(u'dayjournal_summaryinventory', 'actual', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'SummaryInventory.sales'
        db.alter_column(u'dayjournal_summaryinventory', 'sales', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'SummaryInventory.particular'
        db.alter_column(u'dayjournal_summaryinventory', 'particular_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ledger.Account']))
    ...
    models = {
        ...
        u'dayjournal.summaryinventory': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'opening': ('django.db.models.fields.IntegerField', [], {}),
        ...
        u'dayjournal.summaryutility': {
            ...
            'amount': ('django.db.models.fields.FloatField', [], {}),
            'day_journal': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'summary_utility'", 'to': u"orm['dayjournal.DayJournal']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
