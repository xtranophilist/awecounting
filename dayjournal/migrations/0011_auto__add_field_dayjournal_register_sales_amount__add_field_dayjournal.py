...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'DayJournal', fields ['voucher_no']
        db.delete_unique('day_journal', ['voucher_no'])

        # Adding field 'DayJournal.register_sales_amount'
        db.add_column('day_journal', 'register_sales_amount',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'DayJournal.register_sales_tax'
        db.add_column('day_journal', 'register_sales_tax',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'DayJournal.register_sales_amount'
        db.delete_column('day_journal', 'register_sales_amount')

        # Deleting field 'DayJournal.register_sales_tax'
        db.delete_column('day_journal', 'register_sales_tax')

        # Adding unique constraint on 'DayJournal', fields ['voucher_no']
        db.create_unique('day_journal', ['voucher_no'])
    ...
    models = {
        ...
        u'dayjournal.dayjournal': {
            ...
            'status': ('django.db.models.fields.CharField', [], {'default': "'Approved'", 'max_length': '10'}),
