...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DayJournal.scratch_off_sales_manual'
        db.add_column('day_journal', 'scratch_off_sales_manual',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DayJournal.scratch_off_sales_manual'
        db.delete_column('day_journal', 'scratch_off_sales_manual')
