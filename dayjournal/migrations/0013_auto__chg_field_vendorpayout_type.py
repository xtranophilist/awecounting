...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'VendorPayout.type'
        db.alter_column(u'dayjournal_vendorpayout', 'type', self.gf('django.db.models.fields.CharField')(max_length=10))

    def backwards(self, orm):

        # Changing field 'VendorPayout.type'
        db.alter_column(u'dayjournal_vendorpayout', 'type', self.gf('django.db.models.fields.CharField')(max_length=3))
