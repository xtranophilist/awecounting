...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'LottoDetailRow.lotto_detail'
        db.delete_column(u'dayjournal_lottodetailrow', 'lotto_detail_id')

        # Adding field 'LottoDetailRow.day_journal'
        db.add_column(u'dayjournal_lottodetailrow', 'day_journal',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['dayjournal.DayJournal']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Adding field 'LottoDetailRow.lotto_detail'
        db.add_column(u'dayjournal_lottodetailrow', 'lotto_detail',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['dayjournal.LottoDetail']),
                      keep_default=False)

        # Deleting field 'LottoDetailRow.day_journal'
        db.delete_column(u'dayjournal_lottodetailrow', 'day_journal_id')
    ...
    models = {
        ...
        u'dayjournal.lottodetailrow': {
            ...
            'day_journal': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['dayjournal.DayJournal']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
