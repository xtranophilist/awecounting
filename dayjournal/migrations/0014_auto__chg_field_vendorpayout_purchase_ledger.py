...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'VendorPayout.purchase_ledger'
        db.alter_column(u'dayjournal_vendorpayout', 'purchase_ledger_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['ledger.Account']))

    def backwards(self, orm):

        # Changing field 'VendorPayout.purchase_ledger'
        db.alter_column(u'dayjournal_vendorpayout', 'purchase_ledger_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['ledger.Account']))
