...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field transactions on 'CashSales'
        m2m_table_name = db.shorten_name(u'dayjournal_cashsales_transactions')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('cashsales', models.ForeignKey(orm[u'dayjournal.cashsales'], null=False)),
            ('transaction', models.ForeignKey(orm[u'ledger.transaction'], null=False))
        ))
        db.create_unique(m2m_table_name, ['cashsales_id', 'transaction_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field transactions on 'CashSales'
        db.delete_table(db.shorten_name(u'dayjournal_cashsales_transactions'))
