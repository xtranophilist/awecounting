...
class Migration(SchemaMigration):
    def forwards(self, orm):
        ...
        db.create_table(u'dayjournal_cardsales', (
            ...
            ('net', self.gf('django.db.models.fields.FloatField')()),
            ('day_journal', self.gf('django.db.models.fields.related.ForeignKey')(related_name='card_sales',
    ...
    models = {
        u'dayjournal.cardsales': {
            ...
            'net': ('django.db.models.fields.FloatField', [], {})
        },
