...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DayJournal.cash_deposit'
        db.add_column('day_journal', 'cash_deposit',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'DayJournal.cash_withdrawal'
        db.add_column('day_journal', 'cash_withdrawal',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'DayJournal.cheque_deposit'
        db.add_column('day_journal', 'cheque_deposit',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DayJournal.cash_deposit'
        db.delete_column('day_journal', 'cash_deposit')

        # Deleting field 'DayJournal.cash_withdrawal'
        db.delete_column('day_journal', 'cash_withdrawal')

        # Deleting field 'DayJournal.cheque_deposit'
        db.delete_column('day_journal', 'cheque_deposit')
