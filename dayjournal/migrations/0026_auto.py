...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        u'dayjournal.dayjournal': {
            ...
            'cash_deposit_transactions': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'journal_for_deposits'", 'symmetrical': 'False', 'to': u"orm['ledger.Transaction']"}),
            'cash_withdrawal': ('django.db.models.fields.FloatField', [], {}),
            'cash_withdrawal_transactions': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'journal_for_withdrawals'", 'symmetrical': 'False', 'to': u"orm['ledger.Transaction']"}),
            'cheque_deposit': ('django.db.models.fields.FloatField', [], {}),
            'cheque_deposit_transactions': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'journal_for_cheque_deposits'", 'symmetrical': 'False', 'to': u"orm['ledger.Transaction']"}),
