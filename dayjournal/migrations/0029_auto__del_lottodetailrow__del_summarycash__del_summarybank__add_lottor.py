...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'LottoRow'
        db.create_table(u'dayjournal_lottorow', (
            ...
            ('day_journal', self.gf('django.db.models.fields.related.ForeignKey')(related_name='lotto_details', to=orm['dayjournal.DayJournal'])),
        ))
        db.send_create_signal(u'dayjournal', ['LottoRow'])
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'dayjournal_lottodetailrow', (
            ...
            ('type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ledger.Account'], null=True, blank=True)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        ...
        # Deleting model 'LottoRow'
        db.delete_table(u'dayjournal_lottorow')
    ...
    models = {
        ...
        u'dayjournal.lottorow': {
            'Meta': {'object_name': 'LottoRow'},
