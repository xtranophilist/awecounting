...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'inventory_category', 'code')

        # Adding field 'Category.parent'
        db.add_column(u'inventory_category', 'parent',
                      self.gf('mptt.fields.TreeForeignKey')(blank=True, related_name='children', null=True, to=orm['inventory.Category']),
                      keep_default=False)

        # Adding field 'Category.lft'
        db.add_column(u'inventory_category', u'lft',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=None, db_index=True),
                      keep_default=False)

        # Adding field 'Category.rght'
        db.add_column(u'inventory_category', u'rght',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=None, db_index=True),
                      keep_default=False)

        # Adding field 'Category.tree_id'
        db.add_column(u'inventory_category', u'tree_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=None, db_index=True),
                      keep_default=False)

        # Adding field 'Category.level'
        db.add_column(u'inventory_category', u'level',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=None, db_index=True),
                      keep_default=False)
        ...
        db.alter_column(u'inventory_category', 'name', self.gf('django.db.models.fields.CharField')(max_length=50))
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'inventory_category', 'code',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Category.parent'
        db.delete_column(u'inventory_category', 'parent_id')

        # Deleting field 'Category.lft'
        db.delete_column(u'inventory_category', u'lft')

        # Deleting field 'Category.rght'
        db.delete_column(u'inventory_category', u'rght')

        # Deleting field 'Category.tree_id'
        db.delete_column(u'inventory_category', u'tree_id')

        # Deleting field 'Category.level'
        db.delete_column(u'inventory_category', u'level')


        # Changing field 'Category.description'
        db.alter_column(u'inventory_category', 'description', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Category.name'
        db.alter_column(u'inventory_category', 'name', self.gf('django.db.models.fields.CharField')(max_length=254))
