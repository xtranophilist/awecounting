...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'inventory_item', 'category_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['inventory.Category'], null=True))

    def backwards(self, orm):

        # Changing field 'Item.category'
        db.alter_column(u'inventory_item', 'category_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['inventory.Category']))
