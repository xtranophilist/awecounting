...
class Migration(SchemaMigration):
    def forwards(self, orm):
        ...
        db.add_column(u'inventory_category', 'company',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=5,
                                                                            related_name='inventory_categories',
                                                                            to=orm['users.Company']),
                      keep_default=False)


        # Changing field 'Item.account'
        db.alter_column(u'inventory_item', 'account_id',
                        self.gf('django.db.models.fields.related.OneToOneField')(unique=True,
    ...
    models = {
        ...
        u'inventory.inventorytransaction': {
            ...
            'account': ('django.db.models.fields.related.ForeignKey', [],
                        {'related_name': "'transactions'", 'to': u"orm['inventory.InventoryAccount']"}),
