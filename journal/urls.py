...
urlpatterns = patterns('',
                       ...
                       url(r'^day/save/day_cash_receipt/$', views.save_day_cash_receipt, name='save_day_cash_receipt'),
                       url(r'^day/save/day_cash_payment/$', views.save_day_cash_payment, name='save_day_cash_payment'),
