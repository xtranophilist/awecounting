...
function DayJournal(data) {
    ...
    self.lotto_sales_dispenser_tax = ko.observable(empty_to zero(parseFloat(self.account_by_name('Lotto Sales').tax_rate)) * empty_to_zero(self.lotto_sales_dispenser_amount()) / 100);
