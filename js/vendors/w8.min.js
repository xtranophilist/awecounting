...
function handle_side_menu() {
    ...
    $(".sidebar-collapse").on("click", function () {
        ...
        $(".sidebar-collapse").find('i').toggleClass("icon-double-angle-left").toggleClass("icon-double-angle-right");
    ...
    $(".nav-list").on("click", function (d) {
        ...
        if (c && c.length > 0) {
            ...
            $(b).slideToggle(200).parent().toggleClass("open").find('.arrow').toggleClass('icon-angle-up').toggleClass('icon-angle-down');
            return false
        }
    })
}
