...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'JournalEntry.model_id'
        db.delete_column(u'ledger_journalentry', 'model_id')

        # Adding field 'JournalEntry.object_id'
        db.add_column(u'ledger_journalentry', 'object_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=None),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'JournalEntry.model_id'
        db.add_column(u'ledger_journalentry', 'model_id',
                      self.gf('django.db.models.fields.IntegerField')(default=None),
                      keep_default=False)

        # Deleting field 'JournalEntry.object_id'
        db.delete_column(u'ledger_journalentry', 'object_id')
