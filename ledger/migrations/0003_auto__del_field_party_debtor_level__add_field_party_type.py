...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Party.debtor_level'
        db.delete_column('party', 'debtor_level')

        # Adding field 'Party.type'
        db.add_column('party', 'type',
                      self.gf('django.db.models.fields.CharField')(default='Customer', max_length=17),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Party.debtor_level'
        db.add_column('party', 'debtor_level',
                      self.gf('django.db.models.fields.IntegerField')(default=1, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Party.type'
        db.delete_column('party', 'type')
