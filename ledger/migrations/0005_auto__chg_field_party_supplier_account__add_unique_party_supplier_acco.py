...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Party.supplier_account'
        db.alter_column('party', 'supplier_account_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, null=True, to=orm['ledger.Account']))
        # Adding unique constraint on 'Party', fields ['supplier_account']
        db.create_unique('party', ['supplier_account_id'])


        # Changing field 'Party.customer_account'
        db.alter_column('party', 'customer_account_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, null=True, to=orm['ledger.Account']))
        # Adding unique constraint on 'Party', fields ['customer_account']
        db.create_unique('party', ['customer_account_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Party', fields ['customer_account']
        db.delete_unique('party', ['customer_account_id'])

        # Removing unique constraint on 'Party', fields ['supplier_account']
        db.delete_unique('party', ['supplier_account_id'])


        # Changing field 'Party.supplier_account'
        db.alter_column('party', 'supplier_account_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['ledger.Account']))

        # Changing field 'Party.customer_account'
        db.alter_column('party', 'customer_account_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['ledger.Account']))
