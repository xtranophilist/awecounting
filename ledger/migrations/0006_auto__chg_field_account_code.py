...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Account.code'
        db.alter_column(u'ledger_account', 'code', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))

    def backwards(self, orm):

        # Changing field 'Account.code'
        db.alter_column(u'ledger_account', 'code', self.gf('django.db.models.fields.CharField')(default=None, max_length=10))
