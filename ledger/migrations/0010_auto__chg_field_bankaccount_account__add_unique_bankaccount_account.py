...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'ledger_bankaccount', 'account_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['ledger.Account'], unique=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'BankAccount.account'
        db.alter_column(u'ledger_bankaccount', 'account_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ledger.Account']))
    ...
    models = {
        ...
        u'ledger.account': {
            ...
            'categories': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'accounts'", 'blank': 'True', 'to': u"orm['core.Category']"}),
