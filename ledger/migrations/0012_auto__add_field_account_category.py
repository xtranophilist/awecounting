...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'ledger_account', 'category',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='accounts', blank=True, to=orm['ledger.Category']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Account.category'
        db.delete_column(u'ledger_account', 'category_id')
