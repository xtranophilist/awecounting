...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Account.current_dr'
        db.add_column(u'ledger_account', 'current_dr',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'Account.current_cr'
        db.add_column(u'ledger_account', 'current_cr',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Account.current_dr'
        db.delete_column(u'ledger_account', 'current_dr')

        # Deleting field 'Account.current_cr'
        db.delete_column(u'ledger_account', 'current_cr')
