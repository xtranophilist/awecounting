...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        # Adding field 'JournalEntry.model'
        db.add_column(u'ledger_journalentry', 'model',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=50),
                      keep_default=False)

        # Deleting field 'JournalEntry.content_type'
        db.delete_column(u'ledger_journalentry', 'content_type_id')
