...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Changing field 'Account.current_dr'
        db.alter_column(u'ledger_account', 'current_dr', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'Account.current_cr'
        db.alter_column(u'ledger_account', 'current_cr', self.gf('django.db.models.fields.FloatField')(null=True))

    def backwards(self, orm):
        # Changing field 'Account.current_dr'
        db.alter_column(u'ledger_account', 'current_dr', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'Account.current_cr'
        db.alter_column(u'ledger_account', 'current_cr', self.gf('django.db.models.fields.FloatField')())
