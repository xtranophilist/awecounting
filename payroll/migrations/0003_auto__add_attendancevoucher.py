...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'payroll_attendancevoucher', (
            ...
            ('total_working_days', self.gf('django.db.models.fields.FloatField')()),
            ('full_present_day', self.gf('django.db.models.fields.FloatField')()),
            ('half_present_day', self.gf('django.db.models.fields.FloatField')()),
            ('half_multiplier', self.gf('django.db.models.fields.FloatField')(default=0.5)),
            ('early_late_attendance_day', self.gf('django.db.models.fields.FloatField')()),
            ('early_late_multiplier', self.gf('django.db.models.fields.FloatField')(default=1)),
            ('total_ot_hours', self.gf('django.db.models.fields.FloatField')()),
        ))
