...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AttendanceVoucher.paid'
        db.add_column(u'payroll_attendancevoucher', 'paid',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AttendanceVoucher.paid'
        db.delete_column(u'payroll_attendancevoucher', 'paid')
