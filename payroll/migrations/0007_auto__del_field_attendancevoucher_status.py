...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'AttendanceVoucher.status'
        db.delete_column(u'payroll_attendancevoucher', 'status')


    def backwards(self, orm):
        # Adding field 'AttendanceVoucher.status'
        db.add_column(u'payroll_attendancevoucher', 'status',
