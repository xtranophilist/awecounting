...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GroupPayrollRow.payroll_tax'
        db.add_column(u'payroll_grouppayrollrow', 'payroll_tax',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GroupPayrollRow.payroll_tax'
        db.delete_column(u'payroll_grouppayrollrow', 'payroll_tax')
    ...
    models = {
        ...
        u'payroll.grouppayrollrow': {
            ...
            'payroll_tax': ('django.db.models.fields.FloatField', [], {}),
