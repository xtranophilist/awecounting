...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'GroupPayrollRow.rate_ot_hour'
        db.alter_column(u'payroll_grouppayrollrow', 'rate_ot_hour', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'GroupPayrollRow.payroll_tax'
        db.alter_column(u'payroll_grouppayrollrow', 'payroll_tax', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'GroupPayrollRow.rate_hour'
        db.alter_column(u'payroll_grouppayrollrow', 'rate_hour', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'GroupPayrollRow.rate_day'
        db.alter_column(u'payroll_grouppayrollrow', 'rate_day', self.gf('django.db.models.fields.FloatField')(null=True))

    def backwards(self, orm):

        # Changing field 'GroupPayrollRow.rate_ot_hour'
        db.alter_column(u'payroll_grouppayrollrow', 'rate_ot_hour', self.gf('django.db.models.fields.FloatField')(default=None))

        # Changing field 'GroupPayrollRow.payroll_tax'
        db.alter_column(u'payroll_grouppayrollrow', 'payroll_tax', self.gf('django.db.models.fields.FloatField')(default=None))

        # Changing field 'GroupPayrollRow.rate_hour'
        db.alter_column(u'payroll_grouppayrollrow', 'rate_hour', self.gf('django.db.models.fields.FloatField')(default=None))

        # Changing field 'GroupPayrollRow.rate_day'
        db.alter_column(u'payroll_grouppayrollrow', 'rate_day', self.gf('django.db.models.fields.FloatField')(default=None))
