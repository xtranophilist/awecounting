...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'payroll_deductions', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('particular', self.gf('django.db.models.fields.FloatField')()),
            ('amount', self.gf('django.db.models.fields.FloatField')()),
            ('individual_payroll', self.gf('django.db.models.fields.related.ForeignKey')(related_name='exclusions', to=orm['payroll.IndividualPayroll'])),
        ))
        db.send_create_signal(u'payroll', ['Deductions'])
        ...
        db.create_table(u'payroll_individualpayroll', (
            ...
            ('days_worked', self.gf('django.db.models.fields.FloatField')()),
            ('hours_worked', self.gf('django.db.models.fields.FloatField')()),
            ('ot_hours_worked', self.gf('django.db.models.fields.FloatField')()),
            ('day_rate', self.gf('django.db.models.fields.FloatField')()),
            ('hour_rate', self.gf('django.db.models.fields.FloatField')()),
            ('ot_hour_rate', self.gf('django.db.models.fields.FloatField')()),
        ))
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'payroll_deductions')
    ...
    models = {
        ...
        u'payroll.deductions': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'individual_payroll': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'exclusions'", 'to': u"orm['payroll.IndividualPayroll']"}),
        ...
        u'payroll.individualpayroll': {
            ...
            'days_worked': ('django.db.models.fields.FloatField', [], {}),
            'employee': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['payroll.Employee']"}),
            ...
            'ot_hours_worked': ('django.db.models.fields.FloatField', [], {}),
            'voucher_no': ('django.db.models.fields.CharField', [], {'max_length': '50'})
        },
        u'payroll.workday': {
