...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'IndividualPayroll.days_worked'
        db.delete_column(u'payroll_individualpayroll', 'days_worked')

        # Deleting field 'IndividualPayroll.hours_worked'
        db.delete_column(u'payroll_individualpayroll', 'hours_worked')

        # Deleting field 'IndividualPayroll.ot_hours_worked'
        db.delete_column(u'payroll_individualpayroll', 'ot_hours_worked')


    def backwards(self, orm):
        # Adding field 'IndividualPayroll.days_worked'
        db.add_column(u'payroll_individualpayroll', 'days_worked',
                      self.gf('django.db.models.fields.FloatField')(default=None),
                      keep_default=False)

        # Adding field 'IndividualPayroll.hours_worked'
        db.add_column(u'payroll_individualpayroll', 'hours_worked',
                      self.gf('django.db.models.fields.FloatField')(default=None),
                      keep_default=False)

        # Adding field 'IndividualPayroll.ot_hours_worked'
        db.add_column(u'payroll_individualpayroll', 'ot_hours_worked',
                      self.gf('django.db.models.fields.FloatField')(default=None),
                      keep_default=False)
