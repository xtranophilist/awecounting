...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'IndividualPayroll.day_rate'
        db.alter_column(u'payroll_individualpayroll', 'day_rate', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'IndividualPayroll.hour_rate'
        db.alter_column(u'payroll_individualpayroll', 'hour_rate', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'IndividualPayroll.ot_hour_rate'
        db.alter_column(u'payroll_individualpayroll', 'ot_hour_rate', self.gf('django.db.models.fields.FloatField')(null=True))

    def backwards(self, orm):

        # Changing field 'IndividualPayroll.day_rate'
        db.alter_column(u'payroll_individualpayroll', 'day_rate', self.gf('django.db.models.fields.FloatField')(default=None))

        # Changing field 'IndividualPayroll.hour_rate'
        db.alter_column(u'payroll_individualpayroll', 'hour_rate', self.gf('django.db.models.fields.FloatField')(default=None))

        # Changing field 'IndividualPayroll.ot_hour_rate'
        db.alter_column(u'payroll_individualpayroll', 'ot_hour_rate', self.gf('django.db.models.fields.FloatField')(default=None))
