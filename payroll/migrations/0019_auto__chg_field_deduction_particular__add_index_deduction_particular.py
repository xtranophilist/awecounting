...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'Deduction.particular' to match new field type.
        db.rename_column(u'payroll_deduction', 'particular', 'particular_id')
        # Changing field 'Deduction.particular'
        db.alter_column(u'payroll_deduction', 'particular_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ledger.Account']))
        # Adding index on 'Deduction', fields ['particular']
        db.create_index(u'payroll_deduction', ['particular_id'])


    def backwards(self, orm):
        # Removing index on 'Deduction', fields ['particular']
        db.delete_index(u'payroll_deduction', ['particular_id'])


        # Renaming column for 'Deduction.particular' to match new field type.
        db.rename_column(u'payroll_deduction', 'particular_id', 'particular')
        # Changing field 'Deduction.particular'
        db.alter_column(u'payroll_deduction', 'particular', self.gf('django.db.models.fields.FloatField')())
