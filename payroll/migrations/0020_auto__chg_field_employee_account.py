...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Employee.account'
        db.alter_column(u'payroll_employee', 'account_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['ledger.Account'], unique=True, null=True))

    def backwards(self, orm):

        # Changing field 'Employee.account'
        db.alter_column(u'payroll_employee', 'account_id', self.gf('django.db.models.fields.related.OneToOneField')(default=None, to=orm['ledger.Account'], unique=True))
