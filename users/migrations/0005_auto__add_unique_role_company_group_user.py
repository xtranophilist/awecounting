...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Role', fields ['company', 'group', 'user']
        db.create_unique(u'users_role', ['company_id', 'group_id', 'user_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Role', fields ['company', 'group', 'user']
        db.delete_unique(u'users_role', ['company_id', 'group_id', 'user_id'])
