...
def create_default(company):
    ...
    Account(name='Cigarette/Tobacco Sales', category=sales, tax_rate=8.25, code='4-0002', company=company).save()
    Account(name='Soda Sales', category=sales, tax_rate=8.25, code='4-0003', company=company).save()
