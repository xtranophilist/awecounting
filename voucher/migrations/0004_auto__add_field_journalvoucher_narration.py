...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'JournalVoucher.narration'
        db.add_column(u'voucher_journalvoucher', 'narration',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'JournalVoucher.narration'
        db.delete_column(u'voucher_journalvoucher', 'narration')
