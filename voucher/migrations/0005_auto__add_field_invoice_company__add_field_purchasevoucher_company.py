...
class Migration(SchemaMigration):
    def forwards(self, orm):
        ...
        db.add_column('invoice', 'company',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=5, to=orm['users.Company']),
                      keep_default=False)

        # Adding field 'PurchaseVoucher.company'
        db.add_column(u'voucher_purchasevoucher', 'company',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=5, to=orm['users.Company']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('invoice', 'company_id')

        # Deleting field 'PurchaseVoucher.company'
        db.delete_column(u'voucher_purchasevoucher', 'company_id')
