...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'JournalVoucherRow.dr_account'
        db.delete_column(u'voucher_journalvoucherrow', 'dr_account_id')

        # Deleting field 'JournalVoucherRow.sn'
        db.delete_column(u'voucher_journalvoucherrow', 'sn')

        # Deleting field 'JournalVoucherRow.cr_account'
        db.delete_column(u'voucher_journalvoucherrow', 'cr_account_id')

        # Adding field 'JournalVoucherRow.type'
        db.add_column(u'voucher_journalvoucherrow', 'type',
                      self.gf('django.db.models.fields.CharField')(default='Dr', max_length=2),
                      keep_default=False)

        # Adding field 'JournalVoucherRow.account'
        db.add_column(u'voucher_journalvoucherrow', 'account',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='account_rows', to=orm['ledger.Account']),
                      keep_default=False)

        # Adding field 'JournalVoucherRow.description'
        db.add_column(u'voucher_journalvoucherrow', 'description',
                      self.gf('django.db.models.fields.TextField')(default=None),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'JournalVoucherRow.dr_account'
        db.add_column(u'voucher_journalvoucherrow', 'dr_account',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='dr_rows', null=True, to=orm['ledger.Account'], blank=True),
                      keep_default=False)

        # Adding field 'JournalVoucherRow.sn'
        db.add_column(u'voucher_journalvoucherrow', 'sn',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'JournalVoucherRow.cr_account'
        db.add_column(u'voucher_journalvoucherrow', 'cr_account',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='cr_rows', null=True, to=orm['ledger.Account'], blank=True),
                      keep_default=False)

        # Deleting field 'JournalVoucherRow.type'
        db.delete_column(u'voucher_journalvoucherrow', 'type')

        # Deleting field 'JournalVoucherRow.account'
        db.delete_column(u'voucher_journalvoucherrow', 'account_id')

        # Deleting field 'JournalVoucherRow.description'
        db.delete_column(u'voucher_journalvoucherrow', 'description')
