...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PurchaseVoucher.attachment'
        db.add_column(u'voucher_purchasevoucher', 'attachment',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PurchaseVoucher.attachment'
        db.delete_column(u'voucher_purchasevoucher', 'attachment')
    ...
    models = {
        ...
        u'core.party': {
            ...
            'debtor_level': ('django.db.models.fields.IntegerField', [], {'default': '1'}),
