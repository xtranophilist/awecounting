...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Particular.discount'
        db.alter_column(u'voucher_particular', 'discount', self.gf('django.db.models.fields.FloatField')(null=True))

    def backwards(self, orm):

        # Changing field 'Particular.discount'
        db.alter_column(u'voucher_particular', 'discount', self.gf('django.db.models.fields.FloatField')(default=0))
