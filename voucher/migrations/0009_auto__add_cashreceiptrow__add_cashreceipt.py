...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'voucher_cashreceiptrow', (
            ...
            ('invoice', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['voucher.Invoice'])),
            ('receipt', self.gf('django.db.models.fields.FloatField')()),
        ...
        db.create_table(u'voucher_cashreceipt', (
            ...
            ('receipt_on', self.gf('django.db.models.fields.DateField')()),
