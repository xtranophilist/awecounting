...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Particular.account'
        db.alter_column(u'voucher_particular', 'account_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ledger.Account'], null=True))

    def backwards(self, orm):

        # Changing field 'Particular.account'
        db.alter_column(u'voucher_particular', 'account_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['ledger.Account']))
