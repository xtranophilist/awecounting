...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('invoice', 'status',
                      self.gf('django.db.models.fields.CharField')(default='Unapproved', max_length=10),
                      keep_default=False)

        # Adding field 'Invoice.pending_amount'
        db.add_column('invoice', 'pending_amount',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('invoice', 'status')

        # Deleting field 'Invoice.pending_amount'
        db.delete_column('invoice', 'pending_amount')
