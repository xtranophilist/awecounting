...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'voucher_particular', 'tax_scheme_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tax.TaxScheme'], null=True))

    def backwards(self, orm):

        # Changing field 'Particular.tax_scheme'
        db.alter_column(u'voucher_particular', 'tax_scheme_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['tax.TaxScheme']))
