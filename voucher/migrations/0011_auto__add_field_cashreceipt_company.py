...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CashReceipt.company'
        db.add_column(u'voucher_cashreceipt', 'company',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['users.Company']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CashReceipt.company'
        db.delete_column(u'voucher_cashreceipt', 'company_id')
