...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Adding field 'PurchaseVoucher.due_date'
        db.add_column(u'voucher_purchasevoucher', 'due_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'PurchaseVoucher.reference'
        db.add_column(u'voucher_purchasevoucher', 'reference',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PurchaseVoucher.due_date'
        db.delete_column(u'voucher_purchasevoucher', 'due_date')

        # Deleting field 'PurchaseVoucher.reference'
        db.delete_column(u'voucher_purchasevoucher', 'reference')
