...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CashReceipt.status'
        db.add_column(u'voucher_cashreceipt', 'status',
                      self.gf('django.db.models.fields.CharField')(default='Unapproved', max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CashReceipt.status'
        db.delete_column(u'voucher_cashreceipt', 'status')
