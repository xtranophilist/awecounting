...
class Migration(SchemaMigration):
    def forwards(self, orm):
        ...
        db.create_table('purchase_particular', (
            ...
            ('tax_scheme',
             self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tax.TaxScheme'], null=True, blank=True)),
            ('purchase_voucher', self.gf('django.db.models.fields.related.ForeignKey')(related_name='particulars',
                                                                                       to=orm[
        ...
        db.create_table('invoice_particular', (
            ...
            ('tax_scheme',
             self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tax.TaxScheme'], null=True, blank=True)),
            ('invoice', self.gf('django.db.models.fields.related.ForeignKey')(related_name='particulars',
                                                                              to=orm['voucher.Invoice'])),
        ))
