...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CashReceipt.reference'
        db.alter_column(u'voucher_cashreceipt', 'reference', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

    def backwards(self, orm):

        # Changing field 'CashReceipt.reference'
        db.alter_column(u'voucher_cashreceipt', 'reference', self.gf('django.db.models.fields.CharField')(default='', max_length=50))
