...
class Migration(SchemaMigration):
    def forwards(self, orm):
        ...
        db.create_table(u'voucher_journalvoucherrow', (
            ...
            ('dr_account',
             self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='dr_rows', null=True,
                                                                   to=orm['ledger.Account'])),
            ('cr_account',
             self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='cr_rows', null=True,
                                                                   to=orm['ledger.Account'])),
