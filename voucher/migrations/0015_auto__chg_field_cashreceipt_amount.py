...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CashReceipt.amount'
        db.alter_column(u'voucher_cashreceipt', 'amount', self.gf('django.db.models.fields.FloatField')(null=True))

    def backwards(self, orm):

        # Changing field 'CashReceipt.amount'
        db.alter_column(u'voucher_cashreceipt', 'amount', self.gf('django.db.models.fields.FloatField')(default=None))
