...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'voucher_bankdetailrow', (
            ...
            ('bank_detail', self.gf('django.db.models.fields.related.ForeignKey')(related_name='rows', to=orm['voucher.BankDetail'])),
        ))
    ...
    models = {
        ...
        u'voucher.bankdetailrow': {
            'Meta': {'object_name': 'BankDetailRow'},
            'account': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['ledger.Account']"}),
            'amount': ('django.db.models.fields.FloatField', [], {}),
            'bank_detail': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'rows'", 'to': u"orm['voucher.BankDetail']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
