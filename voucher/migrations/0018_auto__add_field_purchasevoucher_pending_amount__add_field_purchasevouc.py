...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PurchaseVoucher.pending_amount'
        db.add_column(u'voucher_purchasevoucher', 'pending_amount',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'PurchaseVoucher.total_amount'
        db.add_column(u'voucher_purchasevoucher', 'total_amount',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PurchaseVoucher.pending_amount'
        db.delete_column(u'voucher_purchasevoucher', 'pending_amount')

        # Deleting field 'PurchaseVoucher.total_amount'
        db.delete_column(u'voucher_purchasevoucher', 'total_amount')
