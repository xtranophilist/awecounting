...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Adding field 'JournalVoucher.voucher_no'
        db.add_column(u'voucher_journalvoucher', 'voucher_no',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'JournalVoucher.voucher_no'
        db.delete_column(u'voucher_journalvoucher', 'voucher_no')
