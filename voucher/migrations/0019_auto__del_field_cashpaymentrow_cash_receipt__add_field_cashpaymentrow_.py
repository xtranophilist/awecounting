...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CashPaymentRow.cash_receipt'
        db.delete_column(u'voucher_cashpaymentrow', 'cash_receipt_id')

        # Adding field 'CashPaymentRow.cash_payment'
        db.add_column(u'voucher_cashpaymentrow', 'cash_payment',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='rows', to=orm['voucher.CashPayment']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'CashPaymentRow.cash_receipt'
        db.add_column(u'voucher_cashpaymentrow', 'cash_receipt',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='rows', to=orm['voucher.CashPayment']),
                      keep_default=False)

        # Deleting field 'CashPaymentRow.cash_payment'
        db.delete_column(u'voucher_cashpaymentrow', 'cash_payment_id')
