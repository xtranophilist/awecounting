...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'voucher_fixedasset', (
            ...
            ('voucher_number', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('date', self.gf('django.db.models.fields.DateField')()),
            ('reference_number', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
        ...
        db.create_table(u'voucher_additionaldetail', (
            ...
            ('fixed_asset', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['voucher.FixedAsset'])),
        ))
        ...
        db.create_table(u'voucher_fixedassetrow', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('assets_ledger', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ledger.Account'])),
            ('description', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
    ...
    models = {
        ...
        u'voucher.additionaldetail': {
            ...
            'description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'fixed_asset': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['voucher.FixedAsset']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'voucher.fixedasset': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'reference_number': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
            'voucher_number': ('django.db.models.fields.CharField', [], {'max_length': '50'})
        },
