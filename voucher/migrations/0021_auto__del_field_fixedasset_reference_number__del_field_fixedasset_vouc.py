...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'FixedAsset.reference_number'
        db.delete_column(u'voucher_fixedasset', 'reference_number')

        # Deleting field 'FixedAsset.voucher_number'
        db.delete_column(u'voucher_fixedasset', 'voucher_number')

        # Adding field 'FixedAsset.voucher_no'
        db.add_column(u'voucher_fixedasset', 'voucher_no',
                      self.gf('django.db.models.fields.CharField')(default=12, max_length=50),
                      keep_default=False)

        # Adding field 'FixedAsset.reference'
        db.add_column(u'voucher_fixedasset', 'reference',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'FixedAsset.reference_number'
        db.add_column(u'voucher_fixedasset', 'reference_number',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'FixedAsset.voucher_number'
        db.add_column(u'voucher_fixedasset', 'voucher_number',
                      self.gf('django.db.models.fields.CharField')(default=12, max_length=50),
                      keep_default=False)
        ...
        # Deleting field 'FixedAsset.reference'
        db.delete_column(u'voucher_fixedasset', 'reference')
    ...
    models = {
        ...
        u'voucher.fixedassetrow': {
            ...
            'assets_ledger': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['ledger.Account']"}),
            'description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
