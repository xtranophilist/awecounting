...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'FixedAssetRow.assets_ledger'
        db.delete_column(u'voucher_fixedassetrow', 'assets_ledger_id')

        # Adding field 'FixedAssetRow.asset_ledger'
        db.add_column(u'voucher_fixedassetrow', 'asset_ledger',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['ledger.Account']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'FixedAssetRow.assets_ledger'
        db.add_column(u'voucher_fixedassetrow', 'assets_ledger',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['ledger.Account']),
                      keep_default=False)

        # Deleting field 'FixedAssetRow.asset_ledger'
        db.delete_column(u'voucher_fixedassetrow', 'asset_ledger_id')
