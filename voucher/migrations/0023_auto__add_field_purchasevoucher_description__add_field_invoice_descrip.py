...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PurchaseVoucher.description'
        db.add_column(u'voucher_purchasevoucher', 'description',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Invoice.description'
        db.add_column('invoice', 'description',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PurchaseVoucher.description'
        db.delete_column(u'voucher_purchasevoucher', 'description')

        # Deleting field 'Invoice.description'
        db.delete_column('invoice', 'description')
