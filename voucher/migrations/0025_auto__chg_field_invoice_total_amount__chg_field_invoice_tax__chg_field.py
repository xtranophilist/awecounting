...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Invoice.total_amount'
        db.alter_column('invoice', 'total_amount', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'Invoice.tax'
        db.alter_column('invoice', 'tax', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))

        # Changing field 'Invoice.currency'
        db.alter_column('invoice', 'currency_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Currency'], null=True))

        # Changing field 'Invoice.date'
        db.alter_column('invoice', 'date', self.gf('django.db.models.fields.DateField')(null=True))
        ...
        # Changing field 'Invoice.pending_amount'
        db.alter_column('invoice', 'pending_amount', self.gf('django.db.models.fields.FloatField')(null=True))

    def backwards(self, orm):

        # Changing field 'Invoice.total_amount'
        db.alter_column('invoice', 'total_amount', self.gf('django.db.models.fields.FloatField')(default=None))

        # Changing field 'Invoice.tax'
        db.alter_column('invoice', 'tax', self.gf('django.db.models.fields.CharField')(max_length=10))

        # Changing field 'Invoice.currency'
        db.alter_column('invoice', 'currency_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['core.Currency']))

        # Changing field 'Invoice.date'
        db.alter_column('invoice', 'date', self.gf('django.db.models.fields.DateField')(default=None))

        # Changing field 'Invoice.party'
        db.alter_column('invoice', 'party_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['ledger.Party']))

        # Changing field 'Invoice.pending_amount'
        db.alter_column('invoice', 'pending_amount', self.gf('django.db.models.fields.FloatField')(default=None))
