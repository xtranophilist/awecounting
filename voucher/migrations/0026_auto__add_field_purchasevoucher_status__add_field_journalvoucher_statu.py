...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PurchaseVoucher.status'
        db.add_column(u'voucher_purchasevoucher', 'status',
                      self.gf('django.db.models.fields.CharField')(default='Unapproved', max_length=10),
                      keep_default=False)

        # Adding field 'JournalVoucher.status'
        db.add_column(u'voucher_journalvoucher', 'status',
                      self.gf('django.db.models.fields.CharField')(default='Unapproved', max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PurchaseVoucher.status'
        db.delete_column(u'voucher_purchasevoucher', 'status')

        # Deleting field 'JournalVoucher.status'
        db.delete_column(u'voucher_journalvoucher', 'status')
