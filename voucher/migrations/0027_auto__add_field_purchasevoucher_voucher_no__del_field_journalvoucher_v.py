...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PurchaseVoucher.voucher_no'
        db.add_column(u'voucher_purchasevoucher', 'voucher_no',
    ...
    def backwards(self, orm):
        # Deleting field 'PurchaseVoucher.voucher_no'
        db.delete_column(u'voucher_purchasevoucher', 'voucher_no')
