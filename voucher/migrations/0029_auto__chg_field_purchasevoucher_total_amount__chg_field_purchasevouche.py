...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PurchaseVoucher.total_amount'
        db.alter_column(u'voucher_purchasevoucher', 'total_amount', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'PurchaseVoucher.date'
        db.alter_column(u'voucher_purchasevoucher', 'date', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'PurchaseVoucher.party'
        db.alter_column(u'voucher_purchasevoucher', 'party_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ledger.Party'], null=True))

        # Changing field 'PurchaseVoucher.pending_amount'
        db.alter_column(u'voucher_purchasevoucher', 'pending_amount', self.gf('django.db.models.fields.FloatField')(null=True))

    def backwards(self, orm):

        # Changing field 'PurchaseVoucher.total_amount'
        db.alter_column(u'voucher_purchasevoucher', 'total_amount', self.gf('django.db.models.fields.FloatField')(default=None))

        # Changing field 'PurchaseVoucher.date'
        db.alter_column(u'voucher_purchasevoucher', 'date', self.gf('django.db.models.fields.DateField')(default=None))

        # Changing field 'PurchaseVoucher.party'
        db.alter_column(u'voucher_purchasevoucher', 'party_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['ledger.Party']))

        # Changing field 'PurchaseVoucher.pending_amount'
        db.alter_column(u'voucher_purchasevoucher', 'pending_amount', self.gf('django.db.models.fields.FloatField')(default=None))
