...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Invoice.invoice_no'
        db.delete_column('invoice', 'invoice_no')

        # Adding field 'Invoice.voucher_no'
        db.add_column('invoice', 'voucher_no',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Invoice.invoice_no'
        db.add_column('invoice', 'invoice_no',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=20),
                      keep_default=False)

        # Deleting field 'Invoice.voucher_no'
        db.delete_column('invoice', 'voucher_no')
